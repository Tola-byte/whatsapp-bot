...
export const ApiApiFp = function (configuration?: Configuration) {
  return {
    ...
    listCollections(
      ...
      const localVarFetchArgs =
        ApiApiFetchParamCreator(configuration).listCollections(options);
      return (fetch: FetchAPI = defaultFetch, basePath: string = BASE_PATH) => {
        return fetch(
          basePath + localVarFetchArgs.url,
          localVarFetchArgs.options,
...
export class ApiApi extends BaseAPI {
  ...
  public createCollection(
    ...
    return ApiApiFp(this.configuration).createCollection(request, options)(
      this.fetch,
      this.basePath,
    );
  }
  ...
  public getCollection(collectionName: string, options?: RequestInit) {
    return ApiApiFp(this.configuration).getCollection(collectionName, options)(
      this.fetch,
      this.basePath,
    );
  }
  ...
  public listCollections(options?: RequestInit) {
    return ApiApiFp(this.configuration).listCollections(options)(
      this.fetch,
      this.basePath,
    );
  }
